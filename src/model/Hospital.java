...
//    @XmlElement
    ...
    public void addPatient(String name, String address, String passport, long id) {
        ...
        if (patients.contains(p)) {
            throw new IllegalArgumentException("Данный пациент " + p + " уже числится в госпитале");
        }
        patients.add(p);
    }
...
//    }
    ...
    public void addDepartment(Department d) {
        ...
        if (departments.contains(d)) {
            throw new IllegalArgumentException("Данный департамент " + d + " уже числится в госпитале");
        }
        departments.add(d);
    }
    ...
    public void removeDepartment(Department d) throws NoSuchFieldException {
        if (departments == null) {
            throw new NullPointerException("В госпитале нет ни одного департамента!");
        }
        if (!departments.contains(d)) {
            throw new NoSuchFieldException("Данного департамента в госпитале не было найдено");
        }
