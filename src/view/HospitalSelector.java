            ...
            case 1:
                ...
                while (true) {
                    try {
                        ...
                        System.out.println("Ошибка при создании госпиталя. Для повторной попытки нажмите 1, в противном случае нажмите любую другую клавишу ");
                        if (sc.next().equals("1")) {
                            System.out.print("Name: ");
                            name = sc.next();
                            System.out.print("INN: ");
...
//                        Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
            ...
            case 4:
                ...
                try {
                    ...
                    System.out.println(ex.getLocalizedMessage());
                    System.out.println("Ошибка при удалении госпиталя. ");
                    break;
                }
...
//                    Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
            ...
            case 6:
                try {
                    ...
                    System.out.println("Департаментов не найдено! " + ex);
//                        Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
                }
                break;
            case 7:
